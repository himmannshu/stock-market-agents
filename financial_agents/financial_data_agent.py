...
FINANCIAL_DATA_PROMPT = (
    ...
    "information such as income statements, balance sheets, cash flow statements, and key metrics. "
...
class FinancialDataAnalysis(BaseModel):
    ...
    """A comprehensive summary of the company's financial data and performance, based *only* on the tool output."""
    
    key_metrics: List[str]
    """List of key financial metrics and their values, extracted *only* from the tool output."""
    
    growth_analysis: str
    """Analysis of the company's growth trends, based *only* on the tool output."""
    
    risk_factors: Optional[List[str]] = None
    """Optional list of identified financial risk factors, based *only* on the tool output."""
